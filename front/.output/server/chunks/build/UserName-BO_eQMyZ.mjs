...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "container-user-auth-name" }, _attrs))} data-v-d2fe7e9c><div class="item main-user-auth-name" data-v-d2fe7e9c><span data-v-d2fe7e9c>${ssrInterpolate(userName.value)}</span> \xA0<span data-v-d2fe7e9c>${ssrInterpolate(userSurname.value)}</span></div><div class="${ssrRenderClass([{ active: isInCabinet.value }, "item cabinet"])}" data-v-d2fe7e9c><a${ssrRenderAttr("href", setRout())} data-v-d2fe7e9c><span class="flex items-center" data-v-d2fe7e9c>`);
...
//# sourceMappingURL=UserName-BO_eQMyZ.mjs.map
