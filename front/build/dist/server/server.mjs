import { effectScope, shallowReactive, reactive, getCurrentScope, hasInjectionContext, getCurrentInstance, inject, toRef, version, unref, ref, watchEffect, watch, h, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, markRaw, nextTick, computed, onScopeDispose, toRefs, defineComponent, provide, createElementBlock, defineAsyncComponent, Suspense, mergeProps, Transition, Fragment, withCtx, createVNode, useSSRContext, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from "vue";
...
const _routes = [
  {
    name: "activate-uuid",
    path: "/activate/:uuid()",
    component: () => import("./_nuxt/_uuid_-CDX-dzDt.js").then((m) => m.default || m)
  },
  {
    name: "callback-uuid",
    path: "/callback/:uuid()",
    component: () => import("./_nuxt/_uuid_-GzCpU3uR.js").then((m) => m.default || m)
  },
  {
    name: "donation-service-terms",
    path: "/donation-service-terms",
    component: () => import("./_nuxt/donation-service-terms-C6sGPDeC.js").then((m) => m.default || m)
  },
  {
    name: "howtohelp",
    path: "/howtohelp",
    component: () => import("./_nuxt/howtohelp-lHZzrJ7u.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-DawvY8Ja.js").then((m) => m.default || m)
  },
  {
    name: "memories-id",
    path: "/memories/:id()",
    component: () => import("./_nuxt/_id_-Bkbr26aV.js").then((m) => m.default || m)
  },
  {
    name: "panoramas-id",
    path: "/panoramas/:id()",
    component: () => import("./_nuxt/_id_-4T4q5NA8.js").then((m) => m.default || m)
  },
  {
    name: "privacy-policy",
    path: "/privacy-policy",
    component: () => import("./_nuxt/privacy-policy-BM9yNCr7.js").then((m) => m.default || m)
  },
  {
    name: "terms",
    path: "/terms",
    component: () => import("./_nuxt/terms-CcQW4qVX.js").then((m) => m.default || m)
  }
];
...
const LazyIcon = defineAsyncComponent(() => import("./_nuxt/index-BIbsiujd.js").then((r) => r["default"] || r.default || r));
...
const layouts = {
  "404": () => import("./_nuxt/404-Cu5XS6ni.js").then((m) => m.default || m),
  default: () => import("./_nuxt/default-BH1zPDoU.js").then((m) => m.default || m),
  "footers-footer-main": () => import("./_nuxt/FooterMain-frA8Td9N.js").then((m) => m.default || m),
  "headers-header-auth-users": () => import("./_nuxt/HeaderAuthUsers-B9waK0Zf.js").then((m) => m.default || m),
  "headers-header-main": () => import("./_nuxt/HeaderMain-DYfKKYm2.js").then((m) => m.default || m),
  "headers-user-name": () => import("./_nuxt/UserName-BO_eQMyZ.js").then((m) => m.default || m),
  "menu-auth-users-admin-menu": () => import("./_nuxt/AdminMenu-CCIzsgoP.js").then((m) => m.default || m),
  "menu-auth-users-manager-menu": () => import("./_nuxt/ManagerMenu-CAguLx_f.js").then((m) => m.default || m),
  "menu-auth-users-user-menu": () => import("./_nuxt/UserMenu-CmioRHjJ.js").then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-BHTouG_z.js").then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-Q_h4D8R7.js").then((r) => r.default || r));
