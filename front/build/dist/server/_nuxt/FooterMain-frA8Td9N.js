...
const _imports_6 = "" + __buildAssetsURL("Avatar.B6kKElLk.png");
const _sfc_main = {
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(ssrRenderComponent(_component_nuxt_link, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<img${ssrRenderAttr("src", _imports_6)} alt="Avatar logo" width="50" height="50" data-v-75a7761a${_scopeId}><p class="text-center" data-v-75a7761a${_scopeId}> Розроблено Олександром Мелешко <br data-v-75a7761a${_scopeId}> всі права захищені 2024 © </p>`);
      } else {
        return [
          createVNode("img", {
            src: _imports_6,
          ...
          createVNode("p", { class: "text-center" }, [
            ...
            createVNode("br"),
            createTextVNode(" всі права захищені 2024 © ")
          ])
        ];
      }
    }),
...
//# sourceMappingURL=FooterMain-frA8Td9N.js.map
