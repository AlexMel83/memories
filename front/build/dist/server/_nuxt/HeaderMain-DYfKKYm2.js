import { _ as __nuxt_component_0$3 } from "./nuxt-link-WQaQD4mm.js";
import { _ as _imports_0, a as _sfc_main$c } from "./favicon-BzH-OJLC.js";
import { _ as __nuxt_component_2 } from "./Icon-DAERXBl-.js";
import { getCurrentInstance, provide, inject, watchEffect, ref, computed, cloneVNode, h as h$1, Fragment, defineComponent, onMounted, onUnmounted, watch, shallowRef, unref, Teleport, reactive, nextTick, normalizeClass, toRef, resolveComponent, mergeProps, withCtx, createVNode, renderSlot, openBlock, createBlock, createCommentVNode, useSSRContext, resolveDynamicComponent, createSlots, renderList, createTextVNode, toDisplayString, resolveDirective, isRef, withDirectives } from "vue";
import { ssrRenderComponent, ssrRenderClass, ssrRenderSlot, ssrRenderVNode, ssrRenderAttrs, ssrInterpolate, ssrRenderList, ssrRenderStyle, ssrRenderTeleport, ssrRenderAttr, ssrGetDirectiveProps } from "vue/server-renderer";
import { useRoute } from "vue-router";
import { c as useNuxtApp, _ as _export_sfc, m as mergeConfig, f as appConfig, q as useState, e as useAuthStore } from "../server.mjs";
import { u as useUI, _ as __nuxt_component_2$1 } from "./Button-CVML3TA3.js";
import { twMerge, twJoin } from "tailwind-merge";
import { useTimestamp, useEventBus, createSharedComposable, useActiveElement, useDebounceFn, useEventListener } from "@vueuse/core";
...
let A = "DC8F892D-2EBD-447C-A4C8-A03058436FF4", Ye = defineComponent({ name: "Dialog", inheritAttrs: false, props: { as: { type: [Object, String], default: "div" }, static: { type: Boolean, default: false }, unmount: { type: Boolean, default: true }, open: { type: [Boolean, String], default: A }, initialFocus: { type: Object, default: null }, id: { type: String, default: null }, role: { type: String, default: "dialog" } }, emits: { close: (t2) => true }, setup(t2, { emit: i2, attrs: l2, slots: p, expose: s$12 }) {
  ...
  let r = false, g2 = computed(() => t2.role === "dialog" || t2.role === "alertdialog" ? t2.role : (r || (r = true, console.warn(`Invalid role [${g2.value}] passed to <Dialog />. Only \`dialog\` and and \`alertdialog\` are supported. Using \`dialog\` instead.`)), "dialog")), D = ref(0), S2 = l$2(), R2 = computed(() => t2.open === A && S2 !== null ? (S2.value & i$1.Open) === i$1.Open : t2.open), m2 = ref(null), E$22 = computed(() => i$3(m2));
...
defineComponent({ name: "DialogBackdrop", inheritAttrs: false, props: { as: { type: [Object, String], default: "div" }, id: { type: String, default: null } }, setup(t2, { attrs: i2, slots: l2, expose: p }) {
  var r;
...
export {
  HeaderMain as default
};
//# sourceMappingURL=HeaderMain-DYfKKYm2.js.map
