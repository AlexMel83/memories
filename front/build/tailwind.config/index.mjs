...
import jit from "#build/tailwind.config/jit.mjs"
...
const config = { theme, corePlugins, plugins, content, darkMode, safelist, jit, variants, presets, prefix, important, separator, blocklist }
export { config as default, theme, corePlugins, plugins, content, darkMode, safelist, jit, variants, presets, prefix, important, separator, blocklist }